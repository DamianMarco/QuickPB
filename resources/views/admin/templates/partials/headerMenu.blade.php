    	...
    	@if (Auth::user()->rol == "admin")
				 <li class="dropdown {{ Request::segment(1) === 'packages' ? 'active' : null }}">
			          ...
			          <ul class="dropdown-menu">
				        ...
				        <li class="{{ Request::segment(2) ==='view' ? 'active' : null }}"><a href="{{ route('packages.view') }}"><i class="fa fa-archive" aria-hidden="true"></i> Ver paquetes</a></li>
				        <li><a href="{{ url('/logout') }}"><i class="fa fa-sign-out"></i> Cerrar sesión</a></li>
			          </ul>
	        	</li>

    	@else
 			<li class="{{ Request::segment(1) === 'packages' ? 'active' : null }}"><a href="{{ route('packages.view') }}"><i class="fa fa-archive"></i> Mis Paquetes</a></li>
        	...
        	<li class="dropdown {{ Request::segment(1) === 'addresses' ? 'active' : null }}">
		          ...
		          <ul class="dropdown-menu">
		            	...
		            	<li class="{{ Request::segment(2) === 'view' ? 'active' : null }}"> <a href="{{ route('packages.view') }}"><i class="fa fa-archive"></i> Mis Paquetes</a></li>
		                <li><a href="{{ url('/logout') }}"><i class="fa fa-sign-out"></i> Cerrar sesión</a></li>
		          </ul>
        	</li>
    	@endif
